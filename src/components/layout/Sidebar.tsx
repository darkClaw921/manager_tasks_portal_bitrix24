      ...
      >
        ...
        <div className="px-4 py-4 border-t border-white/10 space-y-2">
          ...
          <button
            ...
            disabled={loggingOut}
            className="flex items-center gap-2.5 w-full px-2 py-2 rounded-input text-small text-slate-300 hover:bg-sidebar-hover hover:text-text-inverse transition-colors min-h-[44px] disabled:opacity-50"
          >
            <LogoutIcon />
